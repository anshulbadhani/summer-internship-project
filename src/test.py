...
if __name__ == "__main__":
    test_border_pixel_does_not_crash_and_uses_reflect_padding()
    test_center_map_rejects_outlier_via_median()
    test_flatten_pixel_features_shape_and_flattening_order()
    test_neighbor_map_is_smoothed_average()
    test_neighborhood_vectors_shape_and_values()